...
void CamadaDeEnlaceReceptoraEnquadramentoContagemDeCaracteres(int quadro[]){
    //código
}

void CamadaDeEnlaceReceptoraEnquadramentoInsercaoDeBytes(int quadro[]){
    //código
}
void CamadaEnlaceDadosReceptoraEnquadramento (int quadro[]){
...
void CamadaEnlaceDadosReceptora(int quadro[]){
    ...
    //proxima etapa
    //CamadaDeEnlaceReceptoraControleDeErro();
    //chama próxima Camada
